...
impl NetworkMessageType {
    pub fn from_u8(value: u8) -> Option<Self> {
        match value {
            ...
            0x10 => Some(NetworkMessageType::IdInfBattery),
            0x11 => Some(NetworkMessageType::IdInfStatus),
            0x12 => Some(NetworkMessageType::IdInfPos),
            0x13 => Some(NetworkMessageType::IdInfTime),
