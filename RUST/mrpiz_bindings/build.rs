...
fn main() {
    println!("cargo:rustc-link-search=native=/home/chris/PATO/APP_CORE/RUST/lib_mrpiz/lib");
    ...
    let bindings = bindgen::Builder::default()
        .header("../lib_mrpiz/include/mrpiz/mrpiz.h")
        .header("../lib_mrpiz/include/mrpiz/error.h")
